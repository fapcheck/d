...
export const AchievementsModal: React.FC<AchievementsModalProps> = ({
  ...
  const categories = [
    { id: 'tasks', name: 'Tasks', icon: Target, color: 'text-blue-400' },
    { id: 'streak', name: 'Streaks', icon: Calendar, color: 'text-green-400' },
    { id: 'time', name: 'Time', icon: Clock, color: 'text-purple-400' },
    { id: 'special', name: 'Special', icon: Star, color: 'text-yellow-400' }
  ];
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <motion.div
        ...
        className="bg-[#161b22] border border-white/10 w-full max-w-4xl rounded-3xl shadow-2xl relative z-10 max-h-[80vh] flex flex-col"
      >
